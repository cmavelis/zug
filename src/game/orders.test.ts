...
test('diagonal move blocked when another piece has not left target space', () => {
  // Piece 1 at (1,1) will try to move diagonally to (2,2) with priority 3
  // Piece 2 at (2,2) will already be in (2,2) but planning to move out
