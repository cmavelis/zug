...
const reversedBadBoards = badBoards.map(board=>board.map(side=> side.toReversed()))
console.log(badBoards)
console.log(reversedBadBoards)
...
const answer = permute(pieceSet);

console.log(badBoards.length, 'unfair boards');
